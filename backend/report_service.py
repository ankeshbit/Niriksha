...
class StatutoryReportGenerator:
    ...
    def generate_pdf(
        ...
        # 1. Header: AI-Assisted Legal Metrology Inspection System
        story.append(Paragraph("AI-ASSISTED LEGAL METROLOGY INSPECTION SYSTEM", styles["GovtHeader"]))
        story.append(Paragraph("DEPARTMENT OF CONSUMER AFFAIRS (DoCA) • SIH 2026", styles["GovtHeader"]))
        ...
        disclaimer_text = (
            ...
            "This report is generated by the AI-Assisted Legal Metrology Packaged-Commodity Inspection System for inspection-support purposes. "
